...
export default class MyFeature extends React.Component {
  ...
  // state.
  public onClickRemove = (id: any) => {
    const index = this.data
      .get('articles')
      .findIndex( (a: any) => a.get('id') === id);

    this.data = this.data.update('articles', (a: any) => a.delete(index));
  };
  ...
  public onClickToggle = (id: any) => {
    const index = this.data
      .get('articles')
      .findIndex( (a: any) => a.get('id') === id);

    this.data = this.data.update('articles', (articles: any) =>
      articles.update(index, (a: any) =>
        a.update('display', (display: any) => (display ? '' : 'none'))
      )
    );
  };
